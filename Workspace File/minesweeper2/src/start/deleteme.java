...
public class deleteme extends GraphicsProgram implements MouseMotionListener {
	...
	private static final Color[] TileColors = { Color.white, Color.blue, Color.green, Color.red, new Color(128, 0, 128),
			Color.black, new Color(128, 0, 0), new Color(64, 224, 208), new Color(128, 128, 128) };
	...
	/**
	 * Generates the numbers on each of the tiles throughout the board. Each number
	 * denoted the number of mines surrounding the tile. 0 is not displayed.
	 */
	...
	/**
	 * Prints the appropriate Tile label at Gpoint p and returns the character
	 * printed
	 */
